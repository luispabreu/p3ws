...
If there is a problem, look at the code and try to see where you did
not follow the syntax rules. The line number and message it gives may
help you find the problem.  If you cannot find the problem after a
minute or two, ask for help.

If your code has legal syntax, it should produce the output expected.